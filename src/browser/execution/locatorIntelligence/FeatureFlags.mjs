export class FeatureFlagsRegistry {
    constructor() {
        ...
        this.definitions = {
            ...
            LI_DISAMBIGUATION: { default: false, dependsOn: ['LI_BATCH_RESOLVER', 'LI_IDENTITY_DOCUMENT'], description: 'Enable disambiguation engine for count>1' },
            LI_VERIFICATION: { default: false, dependsOn: ['LI_BATCH_RESOLVER', 'LI_IDENTITY_DOCUMENT'], description: 'Enable post-resolution EID verification' },
