...
class TraceModernizer {
  _contextEntry;
  _snapshotStorage;
  _actionMap = /* @__PURE__ */ new Map();
  _version;
  _pageEntries = /* @__PURE__ */ new Map();
  _jsHandles = /* @__PURE__ */ new Map();
  _consoleObjects = /* @__PURE__ */ new Map();
...
//# sourceMappingURL=traceModernizer.mjs.map
