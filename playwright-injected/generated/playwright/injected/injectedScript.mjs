import { parseAriaSnapshot } from "../isomorphic/ariaSnapshot.mjs";
import { renderAriaSnapshotAsYaml } from "../isomorphic/ariaSnapshotRenderer.mjs";
import { asLocator } from "../isomorphic/locatorGenerators.mjs";
import { splitTestIdAttributeNames } from "../isomorphic/locatorUtils.mjs";
import { parseAttributeSelector, parseSelector, stringifySelector, visitAllSelectorParts } from "../isomorphic/selectorParser.mjs";
import { cacheNormalizedWhitespaces, normalizeWhiteSpace, trimStringWithEllipsis } from "../isomorphic/stringUtils.mjs";
import { generateAriaTree, getAllElementsMatchingExpectAriaTemplate, matchesExpectAriaTemplate, renderAriaTreeAsJSON, findNewElement } from "./ariaSnapshot.mjs";
import { beginDOMCaches, enclosingShadowRootOrDocument, endDOMCaches, isElementVisible, isInsideScope, parentElementOrShadowHost, setGlobalOptions } from "./domUtils.mjs";
import { Highlight } from "./highlight.mjs";
import { kLayoutSelectorNames, layoutSelectorScore } from "./layoutSelectorUtils.mjs";
import { createRoleEngine } from "./roleSelectorEngine.mjs";
import { beginAriaCaches, endAriaCaches, getAriaDisabled, getAriaRole, getCheckedAllowMixed, getCheckedWithoutMixed, getElementAccessibleDescription, getElementAccessibleErrorMessage, getElementAccessibleNameText, getReadonly } from "./roleUtils.mjs";
import { SelectorEvaluatorImpl, sortInDOMOrder } from "./selectorEvaluator.mjs";
import { generateSelector } from "./selectorGenerator.mjs";
import { elementMatchesText, elementText, getElementLabels } from "./selectorUtils.mjs";
import { XPathEngine } from "./xpathSelectorEngine.mjs";
import { ConsoleAPI } from "./consoleApi.mjs";
import { UtilityScript } from "./utilityScript.mjs";
class InjectedScript {
  _engines;
  _evaluator;
  _stableRafCount;
  _browserName;
  _shouldPrependErrorPrefix;
  _isUtilityWorld;
  onGlobalListenersRemoved;
  _hitTargetInterceptor;
  _highlight;
  isUnderTest;
  _sdkLanguage;
  _frameSeq;
  _testIdAttributeNameForStrictErrorAndConsoleCodegen = "data-testid";
  window;
  document;
  consoleApi;
  ...
  _booleanAttributes;
  _eventTypes;
  _hoverHitTargetInterceptorEvents;
  _tapHitTargetInterceptorEvents;
  _mouseHitTargetInterceptorEvents;
  _allHitTargetInterceptorEvents;
...
//# sourceMappingURL=injectedScript.mjs.map
