import * as aria from "../isomorphic/ariaSnapshot.mjs";
import { renderAriaSnapshotAsYaml } from "../isomorphic/ariaSnapshotRenderer.mjs";
import { normalizeWhiteSpace, truncateDataUrl } from "../isomorphic/stringUtils.mjs";
import { distillAriaSnapshot } from "./ariaSnapshotDistiller.mjs";
import { computeBox, getElementComputedStyle, isElementVisible } from "./domUtils.mjs";
...
const cachedRegexSymbol = /* @__PURE__ */ Symbol("cachedRegex");
...
const elementSymbol = /* @__PURE__ */ Symbol("element");
...
//# sourceMappingURL=ariaSnapshot.mjs.map
